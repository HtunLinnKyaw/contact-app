                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST" class="mt-5" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" name="upload" class="form-control" value="<?php echo $current['image']; ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="contact_name" class="form-control" value="<?php echo $current['name']; ?> ">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" name="phone_number" class="form-control" value="<?php echo $current['phone']; ?>">
